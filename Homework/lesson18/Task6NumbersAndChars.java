...
public class Task7NumbersAndChars {

    public static void main(String[] args) {

        var inputFile = new File("D:" + File.separator + "Java_projects" + File.separator + "ITEA" + File.separator + "HomeWork" + File.separator + "Homework" + File.separator + "lesson18" + File.separator + File.separator + "Task7NumbersAndChars" + File.separator + "file.txt");
        var outputFile = new File("D:" + File.separator + "Java_projects" + File.separator + "ITEA" + File.separator + "HomeWork" + File.separator + "Homework" + File.separator + "lesson18" + File.separator + File.separator + "Task7NumbersAndChars" + File.separator + "outfile.txt");
